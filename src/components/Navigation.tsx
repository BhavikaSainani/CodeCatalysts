...
import { Menu, X, Leaf, FileText, Target, TrendingUp, Map, Info, Newspaper, MessageSquare, LogOut, Globe, Users } from "lucide-react";
...
const navLinks = [
  ...
  { name: "Peer Network", path: "/peer-network", icon: Users },
